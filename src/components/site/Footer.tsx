  ...
  return (
    <footer className="relative px-6 pt-24 pb-10 overflow-hidden border-t border-white/15">
      <div aria-hidden className="pointer-events-none absolute inset-0 -z-10">
        ...
        <div
          className="blob absolute bottom-0 right-0 h-[380px] w-[380px] rounded-full bg-white opacity-10 blur-3xl"
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-10 reveal reveal-delay-2">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <a href="/#services" className="ulink text-white/80 hover:text-white">
                  Services
                </a>
              </li>
              <li>
                <a href="/#who" className="ulink text-white/80 hover:text-white">
                  Who we work with
                </a>
              </li>
              <li>
                <a href="/#how" className="ulink text-white/80 hover:text-white">
                  How it works
                </a>
              </li>
              <li>
                <a href="/#ai" className="ulink text-white/80 hover:text-white">
                  AI Visibility
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="/#faq" className="ulink text-white/80 hover:text-white">
                  FAQ
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <a
                  href="https://youtube.com/@basicsocials"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="ulink text-white/80 hover:text-white"
                >
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <a href="tel:+919866472562" className="ulink text-white/80 hover:text-white">
                  +91 9866472562
                </a>
              </li>
              <li>
        ...
        <div className="mt-14 pt-6 border-t border-white/10 flex flex-wrap items-center justify-between gap-3 text-xs text-white/55">
          <span>© 2026 Basic Socials. All rights reserved.</span>
          <a href="/privacy" className="ulink hover:text-white transition-colors">
            Privacy Policy
          </a>
        </div>
      </div>
