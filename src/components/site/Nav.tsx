...
export function Nav() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 flex justify-center px-4 pt-4">
      ...
      >
        <a href="#top" aria-label="Basic Socials — Home" className="pl-2 pr-3 flex items-center">
          <img src={logo} alt="Basic Socials" className="h-10 w-10 md:h-11 md:w-11 object-contain" />
        </a>
